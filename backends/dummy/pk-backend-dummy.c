 ...
 */
void
pk_backend_job_start (PkBackend *backend, PkBackendJob *job)
{
	...
	pk_backend_job_message (job, PK_MESSAGE_ENUM_AUTOREMOVE_IGNORED, "backend is crap");
 ...
 */
void
pk_backend_job_stop (PkBackend *backend, PkBackendJob *job)
{
	PkBackendDummyJobData *job_data = pk_backend_job_get_user_data (job);
